...
public class CategoryAdapter extends FragmentPagerAdapter {
    ...
    public Fragment getItem(int position) {
        if (position == 0) {
            ...
            return new FamilyAttractionsFragment();
        } else {
            return new AdultAttractionsFragment();
        }
    }
    ...
    public CharSequence getPageTitle(int position) {
        if (position == 0) {
            ...
            return mContext.getString(R.string.family_category);
        } else {
            return mContext.getString(R.string.adult_category);
        }
    }
}
